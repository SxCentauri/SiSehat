...
<head>
  ...
  <title>Atur Ulang Password — MediCare</title>
...
<body>
  ...
  <main class="wrap">
    <section class="left">
      ...
      <p>Masukkan password baru Anda. Pastikan kuat dan mudah diingat.</p>
    </section>

    <section class="right">
      <div class="hdr">
        <h1>Password Baru</h1>
        <p>Isi form berikut untuk menyelesaikan reset</p>
      </div>
      ...
      <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="group">
          ...
          <input id="email" type="email" name="email" class="in" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" placeholder="nama@contoh.com">
        </div>

        <div class="group">
          <label for="password">Password Baru</label>
          <input id="password" type="password" name="password" class="in" required autocomplete="new-password" placeholder="••••••••">
        </div>

        <div class="group">
          <label for="password_confirmation">Konfirmasi Password</label>
          <input id="password_confirmation" type="password" name="password_confirmation" class="in" required autocomplete="new-password" placeholder="Ulangi password">
        </div>
