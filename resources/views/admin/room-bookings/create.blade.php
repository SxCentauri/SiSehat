...
<head>
    ...
    <title>Tambah Booking - MediCare</title>
        ...
        <div class="card">
            ...
            <form method="post" action="{{ route('admin.room-bookings.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="condition" value="{{ old('condition') }}" placeholder="Contoh: Demam tinggi, monitoring, pasca operasi, dsb." required>
                    @error('condition') <span class="error-message">{{ $message }}</span> @enderror
                </div>

                <div class="form-group">
                    <label class="form-label">Catatan Tambahan</label>
                    <textarea class="form-control" name="notes" placeholder="Tambahkan catatan khusus tentang booking ini...">{{ old('notes') }}</textarea>
