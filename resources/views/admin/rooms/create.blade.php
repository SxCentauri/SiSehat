            ...
            <form method="post" action="{{ route('admin.rooms.store') }}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="name" value="{{ old('name') }}" required placeholder="Nama ruangan">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" min="0" name="capacity" value="{{ old('capacity', 0) }}" placeholder="0">
                        @error('capacity') <span class="error-message">{{ $message }}</span> @enderror
                    </div>

                    <div class="form-group">
                        <label class="form-label">Terisi</label>
                        <input class="form-control" type="number" min="0" name="occupied" value="{{ old('occupied', 0) }}" placeholder="0">
                ...
                <div class="actions">
                    ...
                    <a class="btn btn-secondary" href="{{ route('admin.rooms.index') }}">
