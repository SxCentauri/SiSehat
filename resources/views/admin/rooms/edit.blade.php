            ...
            <form method="post" action="{{ route('admin.rooms.update',$room) }}">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" min="0" name="capacity" value="{{ old('capacity',$room->capacity) }}" placeholder="0">
                        @error('capacity') <span class="error-message">{{ $message }}</span> @enderror
                    </div>

                    <div class="form-group">
                        <label class="form-label">Terisi</label>
                        <input class="form-control" type="number" min="0" name="occupied" value="{{ old('occupied',$room->occupied) }}" placeholder="0">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="notes" placeholder="Tambahkan catatan tentang ruangan...">{{ old('notes',$room->notes) }}</textarea>
                </div>

                <div class="actions">
                    <button class="btn btn-primary" type="submit">
                        <i class="fa-solid fa-save"></i> Update Ruangan
                    </button>
                </div>
            </form>
        </div>
