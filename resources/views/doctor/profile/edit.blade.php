...
<head>
  ...
  <title>Edit Profil Dokter - MediCare</title>
        ...
        <form method="POST" action="{{ route('doctor.profile.update') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea name="bio" class="form-control" rows="4" 
                      placeholder="Ceritakan tentang latar belakang dan pengalaman Anda">{{ old('bio', $profile->bio) }}</textarea>
            @error('bio') 
              <span class="error-message">{{ $message }}</span> 
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="clinic_address" class="form-control" 
                   ...
                   placeholder="Alamat lengkap klinik tempat praktek">
        ...
        <form method="POST" action="{{ route('doctor.profile.update') }}" enctype="multipart/form-data">
          ...
          <div class="avatar-preview">
            @if($profile->avatar_path)
              <img src="{{ asset('storage/'.$profile->avatar_path) }}" alt="Avatar Dokter" class="avatar-image">
            @else
              <div class="no-avatar">
